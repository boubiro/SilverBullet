...
namespace RuriLib.ViewModels
{
    ...
    public class SettingsSelenium : ViewModelBase
    {
        ...
        /// <summary>Fast start Browser/// </summary>
        public bool FastStart { get { return fastStart; } set { fastStart = value; OnPropertyChanged(); } }

        private bool disableAutomation;
        /// <summary>
        /// Disable automation (navigator.webdriver true or false)
        /// </summary>
        public bool DisableAutomation { get { return disableAutomation; } set { disableAutomation = value; OnPropertyChanged(); } }
