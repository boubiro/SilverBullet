...
namespace OpenBullet.ViewModels
{
        ...
        public bool RestoreSession()
        {
            ...
            foreach (var r in runners)
            {
                try
                {
                    ...
                    var configVM = SB.ConfigManager.Configs.FirstOrDefault(c => c.Name == r.Config)
                    ...
                    var wordlist = SB.WordlistManager.Wordlists.FirstOrDefault(w => w.Path == r.Wordlist);
    ...
    public class RunnerInstance
    {
        ...
        {
            Id = id;
            ViewModel = new RunnerViewModel(SB.Settings.Environment, SB.Settings.RLSettings);
