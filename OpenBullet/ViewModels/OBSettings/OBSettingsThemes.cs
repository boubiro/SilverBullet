...
namespace OpenBullet.ViewModels
{
    public class OBSettingsThemes : ViewModelBase
    {
        ...
        private string foregroundOcrRate = "#ff77bafd";//blue
        public string ForegroundOcrRate { get { return foregroundOcrRate; } set{ foregroundOcrRate = value; OnPropertyChanged(); } }
